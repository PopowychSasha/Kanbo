...
const SignUpFormFields = ({nicknameError,nickname,onChangeNicknameHandler,
    setNicknameError,setNickname,emailError,email,passwordError
    ,password,onChangeEmailHandler,isEysClosed,toggleShowPasswordHandler,onChangePasswordHandler
    ,setPasswordError,setPassword,setEmailError,setEmail})=>{
  return(
